  ...
  @endif
    <div class="p-4">
      ...
      <div class="flex justify-between items-center">
        ...
        <!--  -->
        <a class="block my-4 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs"
        ...
        <button style="cursor: pointer;" type="submit"
          class="my-4 ml-4 rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-xs">Delete</button>
        </form>
        @endif
